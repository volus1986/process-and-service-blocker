...
function stopService(serviceName: string): void {
...
function disableService(serviceName: string): void {
...
function stopWindowsUpdateSafe(serviceName: string) {
...
export default function stopServices(serviceNames: string[]): void {
